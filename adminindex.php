...
<body class="mdui-drawer-body-left mdui-appbar-with-toolbar  mdui-theme-primary-amber mdui-theme-accent-pink">
    	...
    	<div id="example4-tab1" class="mdui-p-a-2">
			...
			<form action="adminregister.php" method="post">	
			  ...
			  <div class="mdui-textfield mdui-textfield-floating-label">
    			...
    			<label class="mdui-textfield-label">负责片区</label>
    			<input class="mdui-textfield-input" class="search-input" name="chargeblock" required></input>
				<div class="mdui-textfield-error">负责片区不能为空</div>
  			</div>
			 	<!-- 浮动标签、多行文本框 -->
  			<div class="mdui-textfield mdui-textfield-floating-label">
    			<i class="mdui-icon material-icons">lock</i>
	...
	<div class="mdui-row">
	<div class="mdui-col-sm-5 mdui-col-md-5 mdui-col-offset-md-4">
