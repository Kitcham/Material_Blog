			...
			<div class="m">
				...
				if($rows){
					...
					foreach ($rows as $r) {
						...
						//echo "<a href=\"#\" class=\"mdui-list-item mdui-ripple\">Inbox</a>";
							echo "<div class=\"mdui-list-item-content\">";
								echo "<div class=\"mdui-list-item-title mdui-list-item-one-line\">{$r['title']}</div>";
								echo "<div class=\"mdui-list-item-text mdui-list-item-two-line\">{$r['content']}</div>";
							echo "</div>";
						echo "</li>";
					}
				}		
